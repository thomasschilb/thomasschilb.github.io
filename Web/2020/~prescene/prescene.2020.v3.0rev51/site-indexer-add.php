...
<form method="post" name="Add Site" target="_self">
    <br><strong>Site Indexer | add.link</strong><br><br>
	<span class="sub-description">
	Please add only one link at once to our index!</span><br>
	<br><br>
...
$url = $_POST['url'];
	...
	$filename = 'site-indexer-data.html';
		...
		echo 'PRESCENE says thanks! Click <a target="_self" href="?to=site:indexer:live">here</a> for Site Indexer Live.<br><br>';

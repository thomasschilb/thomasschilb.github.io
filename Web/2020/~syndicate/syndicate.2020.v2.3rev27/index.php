...
<ul>
  <li class="dropdown">
    ...
    <div class="dropdown-content">
		<a target="_self" href="?to=syndicate:ftp">AddFiles@Ftp</a>
		<a target="_self" href="?to=syndicate:irc">Chat@Irc</a>
		<a target="_self" href="?to=syndicate:api:whatsapp">SendMessage@WhatsApp</a>
    </div>
  </li>

...
<head>
<head>
<link rel="icon" type="image/png" href="http://digital-syndicate.net/favicon.png">
<link rel="icon" type="image/x-icon" href="http://digital-syndicate.net/favicon.ico">
...
<ul>
  ...
  <li><a href="?to=syndicate:irc" target="_self">IRC</a></li>
...
<table cellpadding="14" cellspacing="0" class="bar-footer" style="width: 100%">
	<tr>
		<td class="text-align-left">Copyright © 2012-2020 SYNDICATE-TDS. All Rights Reserved.</td>
		<td>

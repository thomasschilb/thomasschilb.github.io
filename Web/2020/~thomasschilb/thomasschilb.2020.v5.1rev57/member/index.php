...
<meta name="page-topic" content="TS | Member Area">
...
<!--
  <li class="dropdown">
    <a target="_self" href="javascript:void(0)" class="dropbtn">Project</a>
    <div class="dropdown-content">
      <a target="_self" href="?to=project:archive">Archive</a>
      <a target="_self" href="?to=project:podcast">Podcast</a>
      <a target="_self" href="?to=project:web">Web</a>
    </div>
  </li>
-->
<!--
  <li class="dropdown">
    ...
    <div class="dropdown-content">
      <a target="_self" href="?to=services:email">Email</a>
      <a target="_self" href="?to=services:irc">IRC</a>
    </div>
  </li>
  ...
  <li><a target="_self" href="?to=member:filecloud">FileCloud</a></li>

  <li><a target="_self" href="?to=member:news">News</a></li>
  
  <li><a target="_self" href="?to=member:predb">PreDB</a></li>

  <li><a target="_self" href="?to=member:radio">Radio</a></li>

  <li style="float:right"><a target="_self" href="?to=logout">Logout</a></li>
...
<table cellpadding="25" cellspacing="0" style="width: 100%">
	<tr>
		...
		$to = $_GET['to'];
		# include given
		if ($to == "welcome")      							{include("member-welcome.php");}
		elseif ($to == "member:predb")  				{include("member-predb.php");}
		elseif ($to == "member:filecloud")  		{include("member-filecloud.php");}

		elseif ($to == "login")   							{include("login.php");}
		elseif ($to == "logout")   							{?><meta http-equiv="refresh" content="0; URL=../"><?}
...
#			{include("member.php");$_SESSION['login']=true;}
		...
		# secure
		else {include("member-welcome.php");}
		?>
	</td>
	</tr>
</table>

...
-->
  ...
  <li class="dropdown">
    ...
    <div class="dropdown-content">
      <a target="_self" href="?to=list:darknet">Darknet</a>
      <a target="_self" href="?to=list:exploits">Exploits</a>
      <a target="_self" href="?to=list:file-sharing">File-Sharing</a>
    </div>
  </li>
...
<table cellpadding="25" cellspacing="0" style="width: 100%">
	<tr>
		...
		elseif ($to == "project:archive")  	{include("php/projects-archive.php");}
		elseif ($to == "project:podcast")  	{include("php/projects-podcast.php");}
		elseif ($to == "project:web")  			{include("php/projects-web.php");}
		elseif ($to == "service:email")  		{include("php/services-email.php");}
		elseif ($to == "service:irc")  			{include("php/services-irc.php");}
		elseif ($to == "service:repository")  			{include("php/services-repository.php");}
		elseif ($to == "list:darknet")  			{include("php/links-darknet.php");}
		elseif ($to == "list:exploits")  		{include("php/links-exploits.php");}
		elseif ($to == "list:file-sharing")  {include("php/links-filesharing.php");}
...
<table cellpadding="14" cellspacing="0" class="color-white" style="width: 100%">
	<tr>
		<td class="bar-footer-left"><font size="3">Copyright &copy; 2015-2020 TS.NET All Rights Reserved.</font><br>
		</td>

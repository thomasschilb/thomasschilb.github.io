...
<title>Thomas Schilb | TS.NET</title>
<style>
...
-->
  <li class="dropdown">
    <a target="_self" href="javascript:void(0)" class="dropbtn">Links</a>
    <div class="dropdown-content">
      <a target="_self" href="?to=links:darknet">Darknet</a>
      <a target="_self" href="?to=links:exploits">Exploits</a>
      <a target="_self" href="?to=links:file-sharing">File-Sharing</a>

    </div>
  </li>
  
  <li><a target="_self" href="?to=services:irc">IRC</a></li>
...
<table cellpadding="25" cellspacing="0" style="width: 100%">
	<tr>
		...
		elseif ($to == "services:email")  		{include("php/services-email.php");}
		elseif ($to == "services:irc")  			{include("php/services-irc.php");}
		elseif ($to == "links:darknet")  			{include("php/links-darknet.php");}
		elseif ($to == "links:exploits")  		{include("php/links-exploits.php");}
		elseif ($to == "links:file-sharing")  {include("php/links-filesharing.php");}
...
<table cellpadding="14" cellspacing="0" class="color-white" style="width: 100%">
	<tr>
		<td class="bar-footer-left"><font size="3">Copyright &copy; 2020 TS. All Rights Reserved.</font><br>
		</td>

...
<!-- Logo End -->
	...
	<tr>
		...
		<table cellpadding="10" cellspacing="0" style="width: 100%">
			<tr>
				<td><br><span class="auto-style2">Haftung für Inhalte</span><br>
				<br>Als Diensteanbieter sind wir gemäß § 7 Abs.1 TMG für eigene 
				Inhalte auf diesen Seiten nach den allgemeinen Gesetzen 
				verantwortlich. Nach §§ 8 bis 10 TMG sind wir als 
				Diensteanbieter jedoch nicht verpflichtet, übermittelte oder 
				gespeicherte fremde Informationen zu überwachen oder nach 
				Umständen zu forschen, die auf eine rechtswidrige Tätigkeit 
				hinweisen.<br><br>Verpflichtungen zur Entfernung oder Sperrung 
				...
				<br>
				<br><span class="auto-style2">Haftung für Links</span><br><br>
				...
				Verlinkung nicht erkennbar.<br><br>Eine permanente inhaltliche 
				Kontrolle der verlinkten Seiten ist jedoch ohne konkrete 
				Anhaltspunkte einer Rechtsverletzung nicht zumutbar. Bei 
				Bekanntwerden von Rechtsverletzungen werden wir derartige Links 
				umgehend entfernen.<br><br><br><span class="auto-style2">
				Urheberrecht</span><br><br>Die durch die Seitenbetreiber 
				...
				gestattet.<br><br>Soweit die Inhalte auf dieser Seite nicht vom 
				...
				werden wir derartige Inhalte umgehend entfernen.<br><br><br>
				<span class="auto-style2">Kontakt</span><br><br>
				<a href="mailto:info@schilb.info?subject=SCHILB.INFO">
				info@schilb.info</a><br>
				<a href="mailto:abuse@schilb.info?subject=SCHILB.ABUSE">
				abuse@schilb.info</a></td>
			</tr>
		</table>
		</td>
	</tr>

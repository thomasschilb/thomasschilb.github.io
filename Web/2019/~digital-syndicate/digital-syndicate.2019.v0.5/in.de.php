...
<?php 
	  ...
	  $test = mysqli_query($con, "SELECT * FROM syndicate WHERE ip='$ip'"); // test if ip is given
	if(mysqli_num_rows($test) != 1) {
    mysqli_query($con, "INSERT INTO syndicate SET ip='$ip'"); // else make db entry
    $count = mysqli_num_rows(mysqli_query($con, "SELECT cid FROM syndicate")); // get entry (rows to number)
    $allyearscount = $count + 243430;
	  echo '<br><font color="#808080">No. ' . $allyearscount . '<font size="2"><br><br><br>SEIT DEM JAHR<br><br>- 2012 -<br><br>BIS JETZT!</font></font>';
    mysqli_close($con); 
	}

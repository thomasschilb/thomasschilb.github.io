...
#	  include ('new-ip-warning.en.html');
	  ...
	  echo '<br><font color="#808080">No. ' . $allyearscount . '<font size="2"><br><br><br>SINCE THE YEAR<br><br>- 2012 -<br><br>UNTIL NOW!</font></font>';
      mysqli_close($con); 
	  }

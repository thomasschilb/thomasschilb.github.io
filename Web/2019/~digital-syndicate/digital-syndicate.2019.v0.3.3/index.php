...
<meta name="developer" content="Thomas Schilb">
...
<meta name="page-topic" content="SYNDICATE.CF | The Digital Syndicate">
...
if ($getdomain == "syndicate.bplaced.net") {
	include "in.en.php";
	}
elseif ($getdomain == "syndicate.bplaced.com"){
	include "in.en.php";
	}
elseif ($getdomain == "syndicate.bplaced.de"){
	include "in.de.php";
	}
elseif ($getdomain == "bplaced.net"){
	include "in.en.php";
	}

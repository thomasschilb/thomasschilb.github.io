...
<meta name="copyright" content="(c)2012-2018">
<meta name="description" content="Syndicate.CF | 2019">
...
<br><br>
<center><a href="http://syndicate.cf/" target="_self">
<img height="100" src="img/title.gif" class="auto-style4"></a><br><br></center>
<table align="center" cellpadding="0" cellspacing="0" style="width: 690px">
	...
	<tr>
		<td style="height: 25px; background-color: #333333">&nbsp;Topliste / Voten</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
...
<img style="color: #3F3F3F;" alt="Underground / RR.Topliste" src="img/toplist.raidrush.ws.1.gif" border="1" width="88" height="31"></a>
	...
	<tr>
		<td style="text-align: left; height: 25px; background-color: #333333">&nbsp;Linkliste</td>
	</tr>
	<tr>
...
<a style="color: #3F3F3F;" id="graycol" target="_blank" href="http://www.querverweis.net/site/in/3125">
...
<img style="color: #3F3F3F;" alt="xLinkz" border="1" src="img/xlinkz.to.1.jpg" width="88" height="31"></a>		</td>
	...
	<tr>
		<td>&nbsp;</td>
			...
			<tr>
		<td style="text-align: left; height: 25px; background-color: #333333">&nbsp;IRC 
		(SSL)</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	...
	<tr>
		...
		HexChat: <span class="auto-style2">/server -ssl irc.anonnet.org</span><br>mIRC: <span class="auto-style2">/server -m irc.anonnet.org</span></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
	...
	<tr>
		<td style="text-align: left; height: 25px; background-color: #333333">&nbsp;Sprache w&auml;hlen</td>
	</tr>
			<tr>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td></td></tr><tr><td width="50%" align="left"><img title="DE" src="img/de.gif">&nbsp;&nbsp;/&nbsp;&nbsp;<a href="in.en.php" target="_self" title="EN"><img class="auto-style1" src="img/us.gif"></a></td><td width="50%" align="right"><i><font color="#3f3f3f"></font></i></td></tr></table>
</td>
	</tr>
</table>
<br>
		...
		<span>&nbsp;</span></span><a href="http://thomasschilb.tk/" style="color: #3f3f3f; text-decoration: none; transition: all 0.3s ease-in; font-family: &quot;Trebuchet MS&quot;, &quot;Lucida Sans Unicode&quot;, &quot;Lucida Grande&quot;, &quot;Lucida Sans&quot;, Arial, sans-serif; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: -webkit-center; text-indent: 0px; text-transform: none; white-space: normal; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(0, 0, 0);" target="_blank" class="auto-style3">powered by tsc</a></td>
	</tr>
	...
	<tr>
		<td style="color: #3F3F3F; text-align: center;"><font color="#530000">&bull;&bull;</font><font color="#990000">&bull;&bull;</font><font color="#FF0000">&bull;</font><font color="#FFFFFF">&bull;</font>&nbsp;<font color="#FFFFFF"><b>[</b></font><a href="main.php?lang=de" style="text-decoration: none" target="_self" target"_self"="">&nbsp;EINGANG&nbsp;</a><font color="#FFFFFF"><b>]</b></font>&nbsp;<font color="#FFFFFF">&bull;</font><font color="#FF0000">&bull;</font><font color="#990000">&bull;&bull;</font><font color="#530000">&bull;&bull;</font></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	</tr>
...
#	  echo '<br><font color="#3f3f3f"><b>No.</b> ' . $allyearscount . ' (since 2012)</font>';
	  echo '<br><font color="#3f3f3f"><b>No.</b> ' . $count . ' (2019/20)</font>';
#	  echo '<font color="#3F3F3F">"...you are visitor no. ' . $count . ' of this site.<br>Do not forget to agree to the <a target="_self" href="readme.php">Readme</a>!"</font>';
      mysqli_close($con); 
	  }
      ...
      $count = mysqli_num_rows(mysqli_query($con, "SELECT cid FROM since")); // get entry (rows to number)
      $allyearscount = $count + 209787;
#	  echo '<br><font color="#3f3f3f"><b>No.</b> ' . $allyearscount . ' (2012/19)</font>';
	  echo '<br><font color="#3f3f3f"><b>No.</b> ' . $count . ' (2019/20)</font>';
	  mysqli_close($con); 
	  }
	  ?>

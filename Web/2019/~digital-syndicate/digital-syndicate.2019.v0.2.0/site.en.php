...
elseif ($var == "links") {
	...
	$lvar = $_GET['lcat'];
	if ($lvar == "audio") {
	include("links/l.audio.html");include("links/l.en.total.html");
	}
	elseif ($lvar == "code") {include("links/l.code.html");include("links/l.en.total.html");}
	elseif ($lvar == "design") {include("links/l.design.html");include("links/l.en.total.html");}
    elseif ($lvar == "develope") {include("links/l.develope.html");include("links/l.en.total.html");}
    elseif ($lvar == "document") {include("links/l.document.html");include("links/l.en.total.html");}
    elseif ($lvar == "emulate") {include("links/l.emulate.html");include("links/l.en.total.html");}
    elseif ($lvar == "erotic") {include("links/l.erotic.html");include("links/l.en.total.html");}
    elseif ($lvar == "ftp") {include("links/l.ftp.html");include("links/l.en.total.html");}
	elseif ($lvar == "games") {include("links/l.games.html");include("links/l.en.total.html");}
	elseif ($lvar == "intern") {include("links/l.intern.html");include("links/l.en.total.html");}
    elseif ($lvar == "irc") {include("links/l.irc.html");include("links/l.en.total.html");}
    elseif ($lvar == "link") {include("links/l.link.html");include("links/l.en.total.html");}
    elseif ($lvar == "music") {include("links/l.music.html");include("links/l.en.total.html");}
    elseif ($lvar == "os") {include("links/l.os.html");include("links/l.en.total.html");}
    elseif ($lvar == "portable") {include("links/l.portable.html");include("links/l.en.total.html");}
    elseif ($lvar == "scene") {include("links/l.scene.html");include("links/l.en.total.html");}
    elseif ($lvar == "security") {include("links/l.security.html");include("links/l.en.total.html");}
    elseif ($lvar == "share") {include("links/l.share.html");include("links/l.en.total.html");}
    elseif ($lvar == "storage") {include("links/l.storage.html");include("links/l.en.total.html");}
    elseif ($lvar == "torrent") {include("links/l.torrent.html");include("links/l.en.total.html");}
    elseif ($lvar == "tv") {include("links/l.tv.html");include("links/l.en.total.html");}
    elseif ($lvar == "unlock") {include("links/l.unlock.html");include("links/l.en.total.html");}
    elseif ($lvar == "webmaster") {include("links/l.webmaster.html");include("links/l.en.total.html");}
    elseif ($lvar == "xdcc") {include("links/l.xdcc.html");include("links/l.en.total.html");}
    elseif ($lvar == "all") {include("links/view.php");include("links/l.en.total.html");}
    elseif ($lvar == "") {include("links/l.audio.html");include("links/l.en.total.html");}
    elseif ($lvar > "") {include("links/l.audio.html");include("links/l.en.total.html");}
    else {
	include("links/l.audio.html");include("links/l.en.total.html");}
	}
...
<!--		<td style="color: #3F3F3F">© 2017 All Rights Reserved.</td> -->
	<td style="color: #3F3F3F">
		<center><strong>Copyright&nbsp;</strong>&copy; 2012-2019 <a target="_Self" style="color: #3F3F3F; a{color: #FF0000};text-decoration: none;" href="main.php?lang=en&&menu=1&&cat=readme">All Rights Reserved.</a></span></center>
		</td>
	</tr>
		<tr>
		<td>&nbsp;</td>

...
elseif ($to == "0-day")  			{include("html/0-day.html");include('counter.php');}
...
elseif ($to == "gate")   			{include("html/gate.php");}
elseif ($to == "")                  {include("html/gate.php");}
# secure
else {include("html/gate.php");}
?>

...
$to = $_GET['to'];
# include given
if ($to == "welcome")          		{echo "<br>";include("html/welcome.html");include('counter.php');}
elseif ($to == "web")  			    {echo "<br>";include("html/web.html");include('counter.php');}
elseif ($to == "emule")      		{echo "<br>";include("html/emule.html");include('counter.php');}
elseif ($to == "torrent")      		{echo "<br>";include("html/torrent.html");include('counter.php');}
elseif ($to == "usenet")      		{echo "<br>";include("html/usenet.html");include('counter.php');}
elseif ($to == "xdcc")   			{echo "<br>";include("html/xdcc.html");include('counter.php');}
elseif ($to == "legal")   			{echo "<br>";include("html/legal.html");include('counter.php');}
elseif ($to == "nfo")   			{echo "<br>";include("html/nfo.html");include('counter.php');}
elseif ($to == "gate")   			{echo "<br>";include("php/gate.php");}
elseif ($to == "")                  {echo "<br>";include("php/gate.php");}
# secure

...
elseif ($to == "ftp")  			    {echo "<br>";include("php/header.php");include("php/ftp.php");include('php/footer.php');include('counter.php');}
elseif ($to == "bbs")  			    {echo "<br>";include("php/header.php");include("php/bbs.php");include('php/footer.php');include('counter.php');}

...
src: url('tsc-fonts-homespun.woff2') format('woff2'),
     url('tsc-fonts-homespun.woff') format('woff'),
     url('tsc-fonts-homespun.ttf') format('ttf'),
     url('tsc-fonts-homespun.eot') format('eot'),
     url('tsc-fonts-homespun.svg') format('svg');
font-weight: normal;
font-style: normal;
}
body {

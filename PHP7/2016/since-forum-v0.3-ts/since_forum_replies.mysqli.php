...
if ($id < 1)
{
	header('Location: site.mysqli.php?site=since_forum.mysqli.php');
	exit();
}
ob_end_clean();
?>
<html>
<font face="Courier" size="2" color="black"><br></font>
<head>
<link rel="icon" 
      type="image/png" 
      href="favicon.png">
...
<body>
<b>
<span lang="de"><font size="2" color="#FFFFFF">Forum</font><font size="2" color="#FF0000">.</font><font size="2" color="#FFFFFF"> 
(</font></span><font size="2"><span lang="de"><font size="2" color="#808080">since</font>)</span></font></b></font><a target="_self" href="site.mysqli.php?site=since_forum_topics.mysqli.php&id=<? echo $idtopic; ?>">&nbsp;<img border="0" src="images/up.gif" width="11" height="9"></a><br><br>
...
$query1 = mysqli_query($con, "SELECT * FROM since_forum_replies WHERE topicid = $id ORDER BY id ASC");
$query2 = mysqli_num_rows($query1);
$output2 = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM since_forum_topics WHERE id = $id"));
...
<form target="_self" name="form1" id="form1" method="post" action="site.mysqli.php?site=since_forum_forumpost.mysqli.php&type=replies&id=<? echo $id; ?>&idtopic=<? echo $idtopic; ?>">

...
OPEN "tsc-snake64.top" FOR APPEND AS #1
CLOSE #1

OPEN "tsc-snake64.top" FOR INPUT AS #1
DO WHILE NOT EOF(1)
...
SUB DrawSCREEN
    ...
    LOCATE 3, 34: PRINT "S N A K E 6 4"
...
FUNCTION EndGAME
    ...
    IF FinalSCORE& > ScoreDATA(9).PlayerSCORE THEN
        ...
        IF LEN(Name$) THEN
            ...
            OPEN "tsc-snake64.top" FOR OUTPUT AS #1
            FOR Reps = 0 TO 9
...
SUB Instructions
    ...
    COLOR 6
    LOCATE 12, 18: PRINT "SNAKE64 is a variation on the classic Microsoft"
    LOCATE 13, 18: PRINT "QBasic game NIBBLES."
    COLOR 15
    LOCATE 12, 18: PRINT "SNAKE64": LOCATE 13, 30: PRINT "NIBBLES"
    COLOR 6
    LOCATE 15, 18: PRINT "Steer the Diamondback Snake using the Arrow"
    ...
    COLOR 6
    LOCATE 12, 18: PRINT "With each creature eaten, the snake grows"
...
SUB Intro
    ...
    COLOR 13
    LOCATE 22, 20
    PRINT "(c)2019 by Thomas Schilb (Freeware)"
    FOR x = 152 TO 496
        FOR y = 336 TO 352
        ...
        SELECT CASE SnakePIT(Col, Row)
            CASE IS >= 1000
                IF SnakePIT(Col, Row) MOD 1000 = Rattler(1).WhichWAY THEN
                    IF SnakePIT(Col, Row) \ 1000 = 1 THEN PRINT ""
                    IF SnakePIT(Col, Row) \ 1000 = 2 THEN PRINT ""
                    SnakePIT(Col, Row) = 0
            ...
            CASE IS < 0
                ...
                IF SnakePIT(Col, Row) = -1 THEN
                    COLOR 4: LOCATE 15, 35: PRINT "K L O N K !"

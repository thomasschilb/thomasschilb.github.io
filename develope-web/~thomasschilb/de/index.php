...
<ul>
  ...
  <li class="dropdown">
    <a target="_self" href="javascript:void(0)" class="dropbtn">Linkliste</a>
    <div class="dropdown-content">
      <a target="_self" href="?to=linkliste:darknet">Darknet</a>
      <a target="_self" href="?to=linkliste:exploits">Exploits</a>
      <a target="_self" href="?to=linkliste:file-sharing">File-Sharing</a>
    </div>
  </li>
  <li><a target="_self" href="?to=geld">Geld</a></li>
  <li><a target="_self" href="?to=kontakt">Kontakt</a></li>
  <li style="float:right"><a target="_self" href="?to=uber">&Uuml;ber</a></li>
...
<table cellpadding="25" cellspacing="0" style="width: 100%">
	<tr>
		...
		elseif ($to == "service:irc")							{include("de/content/service-irc.php");}
		elseif ($to == "linkliste:darknet")  					{include("de/content/linklist-darknet.php");}
		elseif ($to == "linkliste:exploits")  					{include("de/content/linklist-exploits.php");}
		elseif ($to == "linkliste:file-sharing")  				{include("de/content/linklist-filesharing.php");}
		elseif ($to == "geld")  								{include("de/content/money.php");}
		elseif ($to == "kontakt")  								{include("de/content/contact.php");}
		elseif ($to == "uber") 									{include("de/content/about.php");}
...
<table cellpadding="14" cellspacing="0" class="color-white" style="width: 100%">
	<tr>
		<td class="bar-footer-left"><font size="3">Copyright © 2015-2020 TS. </font>
